...
web_flow_image="us-central1-docker.pkg.dev/local-volt-431316-m2/cloud-run-source-deploy/stg-nogales-web-flow:1.1.0"
...
# Web Flow
#############################################
email_recipient="info@casadelafamilia.org"
mailchimp_api_key=""
